...
def main():
    ...
    try:
        ...
        while True:
            ...
            circles = cv2.HoughCircles(gray, cv2.HOUGH_GRADIENT, dp=1, minDist=minDist,
            ...
            if circles is not None and len(circles[0]) > 0:
                ...
                if cam3d is not None:
                    ...
                    # 表示
                    cv2.putText(vis, f"Cam[{Xc:.3f},{Yc:.3f},{Zc:.3f}]m", (x - 100, y + 60),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
                    cv2.putText(vis, f"Rob[{Xr:.3f},{Yr:.3f},{Zr:.3f}]m", (x - 100, y + 100),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2, cv2.LINE_AA)
                    cv2.putText(vis, f"D_rob:{dist_mm}mm", (x - 100, y + 140),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)
                    cv2.putText(vis, f"Angle:{angle_deg}deg", (x - 100, y + 180),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)
                    cv2.putText(vis, depth_text, (x + 5, y - 5),

...
サンプルコード
claude codeの実装例:
YOLOv8 + RealSense D405 リアルタイム物体検出
依存: pip install ultralytics pyrealsense2 opencv-python
使い方: python realsense_yolov8.py --model C:\\Users\\guenk\\Yamanashi_Robocon\\nguyen\\src\\yolo\\runs\\ball_detect_v22\\weights\\best.pt
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="YOLOv8 + RealSense D405 リアルタイム検出")
